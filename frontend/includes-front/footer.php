<p class="footer-copyRight">&copy; <span id="footer-year"></span> Mi Tienda <br> Todos los derechos reservados</p>

<div class="footer">
<div class="footer-section footer-section-ubicacion">
    <h3>Ubicación</h3>
    <p>Carrera 30 # 8- XX <br>Centro Comercial Panorama, local XX <br>
         Barranquilla - Atlántico - Colombia <br>
         Teléfono: +57 605 123 45 67
    </p>
</div>
...
<div class="footer-section footer-section-acerca">
    <h3>Acerca de</h3>
    <ul>
...
<div class="footer-section footer-section-atc">
